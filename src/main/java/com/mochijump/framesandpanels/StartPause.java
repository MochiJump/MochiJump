...
public class StartPause extends JPanel {
    ...
    private final Image mochiFaceState1 = new ImageIcon(this.getClass().getResource("/background.png")).getImage(); //<-- consider changing png file name
    private final Image mochiFaceState2 = new ImageIcon(this.getClass().getResource("/blink.png")).getImage();
    // TODO implement blinking mochiFace
    private Image mochiFace;
    private final Image start = new ImageIcon(this.getClass().getResource("/start.png")).getImage();
    private final Image cont = new ImageIcon(this.getClass().getResource("/continue.png")).getImage();
    private final Image exit = new ImageIcon(this.getClass().getResource("/exit.png")).getImage();
    private final Image load = new ImageIcon(this.getClass().getResource("/loadLvl.png")).getImage();
    private Image selectorImage;
    private final Image selectorImage1 = new ImageIcon(this.getClass().getResource("/bone1M.png")).getImage();
    private final Image selectorImage2 = new ImageIcon(this.getClass().getResource("/bone2M.png")).getImage();
    private final Image selectorImage3 = new ImageIcon(this.getClass().getResource("/bone3M.png")).getImage();
    private final Image selectorImage4 = new ImageIcon(this.getClass().getResource("/bone4M.png")).getImage(); //<-- optional (inverted 2M)

    private final JPanel sPScreen = new JPanel();
    ...
    public StartPause(PanelSwitcher s) {
	...
	/**
	 * defunct method forgot what it was for.
	 */
