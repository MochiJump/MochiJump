...
/**
 * Base class that all player and npc characters extend
 * @author andrew
 */
public abstract class GameCharacter {
	...
	// TODO: the number of public variables here is super gross, this should be moved, variables should be private with
	//   setters and getters
